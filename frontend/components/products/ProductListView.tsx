    ...
    <div className="space-y-4">
      {products.map((product) => {
        const isCustomizableProduct =
          product.categoryId === 'poke-bowl' || product.categoryId === 'smoothie-bowl';
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                {isCustomizableProduct ? (
                  <span className="px-4 py-2 bg-[#9CB973] text-white rounded-lg text-sm font-semibold">
                    Personalizar
                  </span>
                ) : (
                  <button
                    onClick={handleAddToCart}
                    className="px-4 py-2 bg-[#6B8E4E] text-white rounded-lg hover:bg-[#5A7A42] transition-colors text-sm"
                  >
                    Agregar
                  </button>
                )}
